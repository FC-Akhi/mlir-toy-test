//===- ToyOps.cpp - Standalone dialect ops definitions ---------*- C++ -*-===//
//
...
// If you only use "#include "mlir/Interfaces/FunctionImplementation.h"" header call, and remove rest of them, this "ToyOps.cpp" compiles fine
...
#include "mlir/Interfaces/FunctionImplementation.h"     // If this one missing, fails everything
#include "mlir/Support/LLVM.h"
#include "mlir/Support/LogicalResult.h"


// Also without using the following headers, this file compiles fine
